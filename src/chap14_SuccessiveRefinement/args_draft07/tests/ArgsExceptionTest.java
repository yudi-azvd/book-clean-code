package chap14_SuccessiveRefinement.args_draft07.tests;

import chap14_SuccessiveRefinement.args_draft07.ArgsException;
...
public class ArgsExceptionTest extends TestCase {
  ...
  public void testInvalidIntegerMessage() throws Exception {
    ...
    assertEquals("Argument -x expects integer but was 'Forty two'.", e.errorMessage());
  }
  ...
  public void testInvalidDoubleMessage() throws Exception {
    ...
    assertEquals("Argument -x expects double but was 'Forty two'.", e.errorMessage());
  }
